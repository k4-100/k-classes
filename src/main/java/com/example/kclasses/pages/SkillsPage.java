package com.example.kclasses.pages;
...
public class SkillsPage extends InteractiveCustomUIPage<SkillsPage.FormEventData> {
  ...
  public static class FormEventData {
    ...
    public static final BuilderCodec<FormEventData> CODEC = BuilderCodec
        ...
        .append(new KeyedCodec<>("@PlayerName", Codec.STRING), (FormEventData o, String v) -> o.playerName = v,
            (FormEventData o) -> o.playerName)
        .add()
        // Input binding - checkbox value
        .append(new KeyedCodec<>("@Notifications", Codec.BOOLEAN), (FormEventData o, Boolean v) -> o.notifications = v,
            (FormEventData o) -> o.notifications)
        .add()
        // Input binding - checkbox value
        .append(new KeyedCodec<>("@Coordinates", Codec.BOOLEAN), (FormEventData o, Boolean v) -> o.coordinates = v,
  ...
  public void build(
    ...
    // Load the form UI
    commandBuilder.append("Pages/SkillsPage.ui");
